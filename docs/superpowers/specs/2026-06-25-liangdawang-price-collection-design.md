...
**品种：** 玉米（初期），后续可扩展小麦、进口粮、国产大豆、生猪

**全量数据：**

| 区域类型 | 省份/大区 | 采集地点数 | 日均记录 | 历史跨度 |
|----------|-----------|-----------|---------|---------|
| 港口 | 北港（锦州港/鲅鱼圈/北良港/葫芦岛港） | 4 | 4 | 2018-09 至今 |
| 港口 | 南港（湛江港/蛇口港/海口港等 18 港） | 18 | 18 | 2018-09 至今 |
| 东北 | 内蒙古（开鲁玉王/通辽梅花等 7 点） | 7 | 7 | 2020-06 至今 |
| 东北 | 黑龙江（青冈龙凤/京粮龙江等 13 点） | 13 | 13 | 2020-06 至今 |
| 东北 | 吉林（中粮榆树/燃料乙醇等 6 点） | 6 | 6 | 2020-06 至今 |
| 东北 | 辽宁（铁岭国投/沈阳） | 2 | 2 | 2020-06 至今 |
| 华北 | 山东（滨州金汇/福洋生物等 26 点） | 26 | 26 | 2020-06 至今 |
| 华北 | 河北（玉锋淀粉/广玉淀粉等 5 点） | 5 | 5 | 2020-06 至今 |
| 华北 | 河南（厚源生物/飞天淀粉等 6 点） | 6 | 6 | 2020-06 至今 |
| 其他 | 陕西/安徽/四川/宁夏/山西/新疆/云南/贵州 | 19 | 19 | 2024~2026 不等 |
| **合计** | **~15 省/大区** | **106** | **106 条/日** | **~6-8 年** |

### 1.4 数据量估算

| 维度 | 数值 |
|------|------|
| 每日增量 | 106 条（工作日），约 26,500 条/年 |
| 首次历史回填 | ≈ 136,000 条（全部 province+area 组合的 getPriceChart 时间序列） |
| 单条存储 | ~200 bytes |
| 历史全量存储 | ~27 MB |
| 年增量存储 | ~5 MB |
| 首次全量采集耗时 | ~5-6 分钟（含 API 限流 1s 间隔 + DB 分批写入 500 条/批） |
| 每日增量耗时 | ~2 分钟 |
